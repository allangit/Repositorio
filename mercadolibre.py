...
class MercadoLibreCrawler(CrawlSpider):
    ...
    # Esto se puede verificar cuando se realiza el scrapy donde la pag cambia el dominio por eso tenemos que meterlo en las listas
    ...
    download_delay = 3# tiempo para darse chance a que la pag carge la configuración se recomienda que sea aleatorio por el baneo
